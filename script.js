...
// -------------------- PRODUCT CORE LOGIC --------------------
// Added "SKU" as a new column, placed after UPC and before STOCK CODE for clarity
...
stockAiBtn.addEventListener('click', openAIModal);
closeModalBtn.addEventListener('click', closeAIModal);
modalOverlay.addEventListener('click', (e) => { if (e.target === modalOverlay) closeAIModal(); });
modalThreshold.addEventListener('input', runFullscreenAnalysis);
modalClassFilter.addEventListener('change', runFullscreenAnalysis);
